...
class Projeto {
    ...
    constructor(
        ...
        private dataInicio: Date,// Lista de marcos do projeto, contendo descrição e prazo (atributo privado)
        private dataTermino: Date// Lista de marcos do projeto, contendo descrição e prazo (atributo privado)
    ) { }
